...
async function buildLandMap(): Promise<Uint8Array> {
  ...
  // Force-mark Tokyo (35.69N, 139.69E) — sits in Tokyo Bay in this map image
  const tokyoCol = Math.floor((139.69+180)/360*MAP_W)
  const tokyoRow = Math.floor((90-35.69)/180*MAP_H)
  result[tokyoRow*MAP_W+tokyoCol] = 1
  return result
}
...
const HOTSPOTS: Hotspot[] = [
  ...
  { name: 'Ibiza',       desc: 'DC10 · Pacha · Amnesia',            lat: 38.91,  lon: 0.20,    tier: 2 },
  { name: 'Amsterdam',   desc: 'Shelter · Awakenings · ADE',        lat: 52.37,  lon: 4.90,    tier: 1 },
  { name: 'Paris',       desc: 'Rex Club · Concrete · Batofar',     lat: 48.86,  lon: 1.80,    tier: 1 },
  ...
  { name: 'Detroit',     desc: 'Movement Festival · CODA',          lat: 42.33,  lon: -83.80,  tier: 1 },
  { name: 'Chicago',     desc: 'Smart Bar · Spy Bar',               lat: 41.88,  lon: -87.63,  tier: 1 },
  { name: 'New York',    desc: 'Output · House of Yes · Nowadays',  lat: 43.00,  lon: -74.20,  tier: 1 },
  { name: 'Rio',         desc: 'Fosfobox · Green Valley',           lat: -21.50, lon: -49.80,  tier: 1 },
  { name: 'Sao Paulo',   desc: 'D-Edge · Lov · The Week',           lat: -22.50, lon: -50.20,  tier: 1 },
  { name: 'Bangkok',     desc: 'De Commune · Onyx · Beam',          lat: 14.00,  lon: 97.20,   tier: 1 },
  { name: 'Koh Phangan', desc: 'Full Moon Party · Shiva Moon',      lat: 9.73,   lon: 100.01,  tier: 1 },
  { name: 'Melbourne',   desc: 'Revolver · Brown Alley · 161',      lat: -34.50, lon: 139.80,  tier: 1 },
  { name: 'Tokyo',       desc: 'Womb · Contact · Dommune',          lat: 35.69,  lon: 139.69,  tier: 1 },
  { name: 'Bali',        desc: 'Potato Head · La Favela',           lat: -8.00,  lon: 114.80,  tier: 0 },
  { name: 'Cape Town',   desc: 'Shimmy Beach · Cause Effect',       lat: -33.00, lon: 18.30,   tier: 0 },
  ...
  { name: 'Dubai',       desc: 'White Dubai · Soho Garden',         lat: 27.00,  lon: 56.20,   tier: 0 },
  { name: 'Seoul',       desc: 'Cakeshop · Contra · Boogie Nights', lat: 38.50,  lon: 126.80,  tier: 0 },
  { name: 'LA',          desc: 'Exchange · Catch One · EDC',        lat: 34.05,  lon: -118.24, tier: 0 },
  { name: 'Toronto',     desc: 'Coda · Rebel · Velvet Underground', lat: 45.50,  lon: -80.20,  tier: 0 },
